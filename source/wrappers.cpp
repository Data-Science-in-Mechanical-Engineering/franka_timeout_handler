...
PYBIND11_MODULE(franka_real_time, m)
{
    ...
    //RobotCore
    pybind11::class_<franka_real_time::RobotCore>(m, "RobotCore")
        ...
        .def("set_target_joint_positions",          &franka_real_time::Robot::set_target_joint_positions)
        .def("set_joint_stiffness",                 &franka_real_time::Robot::set_joint_stiffness)
        .def("set_joint_damping",                   &franka_real_time::Robot::set_joint_damping)
        ...
        .def("get_target_joint_positions",          &franka_real_time::Robot::get_target_joint_positions)
        .def("get_joint_stiffness",                 &franka_real_time::Robot::get_joint_stiffness)
        .def("get_joint_damping",                   &franka_real_time::Robot::get_joint_damping)
        ...
        .def("set_target_joint_positions_update",   &franka_real_time::Robot::set_target_joint_positions_update)
        .def("set_joint_stiffness_update",          &franka_real_time::Robot::set_joint_stiffness_update)
        .def("set_joint_damping_update",            &franka_real_time::Robot::set_joint_damping_update)
        ...
        .def("get_target_joint_positions_update",   &franka_real_time::Robot::get_target_joint_positions_update)
        .def("get_joint_stiffness_update",          &franka_real_time::Robot::get_joint_stiffness_update)
        .def("get_joint_damping_update",            &franka_real_time::Robot::get_joint_damping_update)
    ...
    //Robot
    pybind11::class_<franka_real_time::Robot, franka_real_time::RobotCore>(m, "Robot")
        .def(pybind11::init<std::string>())
        .def("set_translation_impedance",   &franka_real_time::Robot::set_translation_impedance)
        .def("get_translation_impedance",   &franka_real_time::Robot::get_translation_impedance)
        .def("set_rotation_impedance",      &franka_real_time::Robot::set_rotation_impedance)
        .def("get_rotation_impedance",      &franka_real_time::Robot::get_rotation_impedance)
        .def("set_joint_impedance",         &franka_real_time::Robot::set_joint_impedance)
        .def("get_joint_impedance",         &franka_real_time::Robot::get_joint_impedance)
        .def("set_update",                  &franka_real_time::Robot::set_update)
        .def("set_default",                 &franka_real_time::Robot::set_default)
        .def("set_current",                 &franka_real_time::Robot::set_current)
        .def("loop_to_default",             &franka_real_time::Robot::loop_to_default);
}