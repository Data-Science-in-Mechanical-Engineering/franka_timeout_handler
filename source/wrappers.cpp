...
PYBIND11_MODULE(franka_timeout_handler, m)
{
    ...
    pybind11::class_<franka_timeout_handler::RobotCore>(m, "RobotCore")
        ...
        .def("set_target_velocity",                 &franka_timeout_handler::Robot::set_target_velocity,                "Sets cartesian velocity of target (output)")
        .def("set_target_rotation",                 &franka_timeout_handler::Robot::set_target_rotation,                "Sets cartesian rotation of tartget (output)")
        ...
        .def("set_target_joint_velocities",         &franka_timeout_handler::Robot::set_target_joint_velocities,        "Sets joint-space velocity target (output)")
        ...
        .def("get_target_velocity",                 &franka_timeout_handler::Robot::get_target_velocity,                "Returns cartesian velocity of tartget (output)")
        .def("get_target_rotation",                 &franka_timeout_handler::Robot::get_target_rotation,                "Returns cartesian rotation of tartget (output)")
        ...
        .def("get_target_joint_velocities",         &franka_timeout_handler::Robot::get_target_joint_velocities,        "Returns joint-space velocity target (output)")
        ...
        .def("set_target_velocity_update",          &franka_timeout_handler::Robot::set_target_velocity_update,         "Sets update mode of target cartesian velocity (output)")
        .def("set_target_rotation_update",          &franka_timeout_handler::Robot::set_target_rotation_update,         "Sets update mode of target cartesian rotation (output)")
        ...
        .def("set_target_joint_velocities_update",  &franka_timeout_handler::Robot::set_target_joint_velocities_update, "Sets update mode of joint-space velcoity target (output)")
        ...
        .def("get_target_velcity_update",           &franka_timeout_handler::Robot::get_target_velocity_update,         "Returns update mode of target cartesian velocity (output)")
        .def("get_target_rotation_update",          &franka_timeout_handler::Robot::get_target_rotation_update,         "Returns update mode of target cartesian rotation (output)")
        ...
        .def("get_target_joint_velocities_update",  &franka_timeout_handler::Robot::get_target_joint_velocities_update, "Returns update mode of joint-space velocity target (output)")
