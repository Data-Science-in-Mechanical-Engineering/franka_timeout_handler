...
PYBIND11_MODULE(franka_real_time, m)
{
    ...
    pybind11::class_<franka_real_time::Robot>(m, "Robot")
        ...
        .def("set_target_joint_position",           &franka_real_time::Robot::set_target_joint_position)
        ...
        .def("get_target_joint_position",           &franka_real_time::Robot::get_target_joint_position)
        ...
        .def("move_to_reference",                   &franka_real_time::Robot::move_to_reference)
